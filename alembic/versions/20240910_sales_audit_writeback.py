"""Add audit, soft delete, and write-back fields to sales orders, quotations, credit notes."""

from alembic import op
import sqlalchemy as sa

# revision identifiers, used by Alembic.
revision = "20240910_sales_audit_writeback"
down_revision = "20240909_financial_audit_writeback"
branch_labels = None
depends_on = None
...
def upgrade():
    _add_common("sales_orders")
    _add_common("quotations")
    _add_common("credit_notes")


def downgrade():
    for table in ("credit_notes", "quotations", "sales_orders"):
