...
def upgrade() -> None:
    ...
    # ==========================================================================
    if not inspector.has_table("supplier_groups"):
        op.create_table(
            "supplier_groups",
    ...
    # ==========================================================================
    if inspector.has_table("journal_entry_items") and inspector.has_table("accounts"):
        op.add_column(
            "journal_entry_items",
    ...
    # ==========================================================================
    if inspector.has_table("suppliers") and inspector.has_table("supplier_groups"):
        op.add_column(
            "suppliers",
    ...
    if inspector.has_table("sales_orders"):
        if inspector.has_table("sales_persons"):
            op.add_column(
                "sales_orders",
    ...
    # Quotation: sales_partner_id → sales_persons, territory_id → territories
    # ==========================================================================
    if inspector.has_table("quotations"):
        if inspector.has_table("sales_persons"):
            op.add_column(
                "quotations",
                sa.Column("sales_partner_id", sa.Integer(), nullable=True),
    ...
    # Opportunity: campaign_id → campaigns
    # ==========================================================================
    if inspector.has_table("opportunities") and inspector.has_table("campaigns"):
        op.add_column(
            "opportunities",
