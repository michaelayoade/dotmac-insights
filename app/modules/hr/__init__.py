...
NAVIGATION = [
    ...
    },
    {
        ...
        "links": [
            ...
            {"label": "Teams", "href": "/hr/teams", "icon": "users"},
        ],
    },
    {
        "section": "Leave",
        ...
        "order": 30,
        "links": [
            {"label": "Applications", "href": "/hr/leave", "icon": "calendar"},
            {"label": "Types", "href": "/hr/leave/types", "icon": "list"},
            {"label": "Allocations", "href": "/hr/leave/allocations", "icon": "check-square"},
    ...
    },
    {
        ...
        "order": 40,
        "links": [
            {"label": "Records", "href": "/hr/attendance", "icon": "clock"},
    ...
    },
    {
        ...
        "order": 50,
        "links": [
            {"label": "Payslips", "href": "/hr/payroll", "icon": "dollar-sign"},
            {"label": "Runs", "href": "/hr/payroll/runs", "icon": "repeat"},
            {"label": "Structures", "href": "/hr/payroll/structures", "icon": "list"},
        ],
    },
    {
        "section": "Training",
        ...
        "order": 60,
        "links": [
            {"label": "Events", "href": "/hr/training", "icon": "book"},
            {"label": "Programs", "href": "/hr/training/programs", "icon": "book-open"},
        ],
    },
    {
        "section": "Performance",
        ...
        "links": [
            ...
            {"label": "Templates", "href": "/hr/appraisal/templates", "icon": "file-text"},
        ],
    },
    {
        "section": "Recruitment",
        ...
        "links": [
            ...
            {"label": "Offers", "href": "/hr/recruitment/offers", "icon": "file-text"},
        ],
    },
    {
        "section": "Lifecycle",
        "module": "hr",
        "href": "/hr/lifecycle/onboarding",
        "icon": "repeat",
        "scope": "hr:read",
        "order": 90,
        "links": [
