...
ACCOUNTING_ENTITIES: dict[str, EntityConfig] = {
    ...
    "payment_methods": {
        ...
        "fields": {
            "id": {"type": FieldType.INTEGER, "description": "Internal ID"},
            "customer_account_id": {"type": FieldType.FOREIGN_KEY, "required": True, "fk_entity": "customer_accounts", "fk_lookup_fields": ["id", "email", "name"], "description": "Customer"},
        ...
        "required_fields": ["customer_account_id", "method_type"],
        "unique_fields": [],
        "lookup_fields": ["id"],
