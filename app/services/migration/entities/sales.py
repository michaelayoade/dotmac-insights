...
SALES_ENTITIES: dict[str, EntityConfig] = {
    "invoices": {
        ...
        "fields": {
            ...
            "customer_account_id": {"type": FieldType.FOREIGN_KEY, "required": True, "fk_entity": "customer_accounts", "fk_lookup_fields": ["id", "email", "name"], "description": "Customer account"},
        ...
        "required_fields": ["customer_account_id", "invoice_date", "amount"],
        "unique_fields": ["invoice_number"],
        "lookup_fields": ["id", "invoice_number"],
        "dependencies": ["customer_accounts"],
    ...
    "payments": {
        ...
        "required_fields": ["customer_account_id", "payment_date", "amount"],
    ...
    "credit_notes": {
        ...
        "fields": {
            ...
            "customer_account_id": {"type": FieldType.FOREIGN_KEY, "fk_entity": "customer_accounts", "fk_lookup_fields": ["id", "email", "name"], "description": "Customer account"},
        ...
        "dependencies": ["customer_accounts", "invoices"],
        "supports_upsert": True,
        "supports_rollback": True,
    },
}
