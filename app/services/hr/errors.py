...
class EmployeeNotFoundError(NotFoundError):
    ...
    def __init__(
        self, employee_id: int | None = None, message: str | None = None
    ) -> None:
        if message is None:
            message = (
...
class DepartmentNotFoundError(NotFoundError):
    ...
    def __init__(
        self, department_id: int | None = None, message: str | None = None
    ) -> None:
        if message is None:
            message = (
...
class DesignationNotFoundError(NotFoundError):
    ...
    def __init__(
        self, designation_id: int | None = None, message: str | None = None
    ) -> None:
        if message is None:
            message = (
...
class HDTeamNotFoundError(NotFoundError):
    """Raised when a helpdesk team is not found."""

    def __init__(self, team_id: int | None = None, message: str | None = None) -> None:
        if message is None:
            message = (
                f"HD Team not found: {team_id}" if team_id else "HD Team not found"
            )
        super().__init__(message)
