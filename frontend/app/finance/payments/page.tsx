...
export default function PaymentsPage() {
  ...
  const [sortBy, setSortBy] = useState<'payment_date' | 'amount' | 'customer_id' | 'invoice_id' | 'status'>('payment_date');
  ...
  return (
    <div className="space-y-6">
      ...
      <DataTable
        ...
        onRowClick={(item) => router.push(`/finance/payments/${(item as any).id}`)}
