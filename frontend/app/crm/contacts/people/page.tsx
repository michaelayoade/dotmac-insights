...
import { LoadingState, Button, FilterCard, FilterInput, PageHeader } from '@/components/ui';
...
export default function PeoplePage() {
  ...
  if (missingScope) {
    return (
      <AccessDenied
        message="You need the crm:read permission to view people."
        backHref="/crm"
    ...
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        actions={
          canWrite ? (
            <Link
              href="/crm/contacts/new?type=person"
      ...
      >
        <form onSubmit={handleSearch} className="flex-1 min-w-[200px] max-w-md relative">
          ...
          <FilterInput
            ...
            className="w-full pl-10 pr-4 placeholder:text-slate-muted focus:ring-2 focus:ring-purple-500/50"
          />
        </form>
      </FilterCard>
