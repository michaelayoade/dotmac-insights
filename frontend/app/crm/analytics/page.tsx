...
export default function CRMAnalyticsPage() {
  ...
  } = useUnifiedContactsDashboard(30, { isPaused: () => !canFetch }) as {
  ...
  const {
    ...
    error: funnelError,
  } = useUnifiedContactsFunnel(30, undefined, { isPaused: () => !canFetch }) as {
  ...
  if (missingScope) {
    return (
      <AccessDenied
        message="You need the crm:read permission to view CRM analytics."
        backHref="/crm"
  ...
  return (
    <div className="space-y-6">
      {Boolean(dashboardError || funnelError) && (
        <ErrorDisplay
          message="Failed to load CRM analytics"
