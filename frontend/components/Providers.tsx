...
function AuthErrorBanner({ show, message, onDismiss }: { show: boolean; message: string; onDismiss: () => void }) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-red-600 text-foreground px-4 py-3 flex items-center justify-between">
      ...
      <button onClick={onDismiss} className="text-foreground hover:text-gray-200">
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
